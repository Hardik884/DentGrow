          ...
          return (
            <li key={t.id}>
              <button
                ...
                className="w-full text-left rounded-lg border border-border bg-surface-secondary px-3 py-2.5 hover:bg-surface-muted transition-colors"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-text-secondary mt-0.5">
                      ...
                      {t.dentistName && (
                        <span className="text-text-disabled"> · {t.dentistName}</span>
                      )}
                    </p>
                  </div>
                ...
                {t.patient_visible_notes && (
                  <p className="text-xs text-text-secondary mt-1.5 whitespace-pre-wrap line-clamp-2">
                    {t.patient_visible_notes}
                  </p>
                )}
              </button>
