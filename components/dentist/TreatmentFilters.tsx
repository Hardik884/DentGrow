    ...
    <div className="bg-white border border-[#E4E4E7] rounded-xl px-5 py-4 space-y-4">
      ...
      <div className="flex flex-wrap gap-4 items-end">
        ...
        <div className="space-y-1.5 min-w-[160px]">
          <label htmlFor="tx-type" className="text-xs font-medium text-[#71717A] uppercase tracking-wide">
            Treatment Type
          </label>
          <Input
            id="tx-type"
        ...
        <div className="space-y-1.5 min-w-[140px]">
          <label htmlFor="tx-status" className="text-xs font-medium text-[#71717A] uppercase tracking-wide">
            Status
          </label>
          <select
            id="tx-status"
