        ...
        {NAV_ITEMS.slice(0, 5).map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex-1 flex flex-col items-center gap-0.5 py-1.5 px-1 text-[9px] font-medium transition-colors",
                isActive ? "text-accent" : "text-[#A1A1AA]"
              )}
              aria-current={isActive ? "page" : undefined}
            >
              <span
