/**
 * Business Brain — Diagnosis Engine: calendar arithmetic
 *
 * Persistence classification has to know whether two fired days are adjacent,
 * and which calendar dates in a window were never supplied at all. That needs
 * date arithmetic, and the engine is forbidden from touching `Date`.
 *
