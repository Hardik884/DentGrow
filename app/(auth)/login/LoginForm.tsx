  ...
  return (
    <form action={formAction} className="space-y-4" noValidate>
      ...
      {resetSuccess && (
        <div
          role="status"
          className="rounded-lg bg-success-bg border border-success-border px-3.5 py-3 text-xs text-success flex items-start gap-2"
        >
      ...
      <Field label="Password" htmlFor="password">
        ...
        <div className="flex justify-end pt-0.5">
          <a
            ...
            className="text-xs text-text-secondary hover:text-text-primary hover:underline underline-offset-4"
          >
            Forgot password?
          </a>
        </div>
